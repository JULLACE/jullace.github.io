    ...
    return (
        <div className="content">
            ...
            <ol className='nav'>
                ...
                <li>
                    <a href="https://github.com/JULLACE">github</a>
                </li>
                <li onClick={doClick} onMouseOut={outFunc}>
                    <a>
                        <div className="tooltip">
                            <span className="tooltiptext" id="myTooltip">Copy to clipboard</span>
                            julio.llanesc@gmail.com &nbsp;
                            <svg className="clipboard" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
